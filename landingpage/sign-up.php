    ...
    <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20">
          <h1 class="text-center margin-bottom-20">Daftar Sebagai</h1>
          <div class="col-md-6 latest-job ">
            <div class="small-box bg-yellow padding-5">
              ...
              <!-- <a href="register-candidates.php" class="small-box-footer"> -->
                Daftar Disini &nbsp<i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
          <div class="col-md-6 latest-job ">
            <div class="small-box bg-aqua padding-5">
              ...
              <a href="register-pengusaha.php" class="small-box-footer">
                Daftar Disini &nbsp <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
