    ...
    <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          <h1 class="text-center margin-bottom-20">Isi Data Diri Anda</h1>
          <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
            <div class="col-md-12 latest-job ">
              ...
              <div class="form-group">
                <input class="form-control input-lg" type="password" id="password" name="password" placeholder="Kata Sandi *" required>
              </div>
              <div class="form-group">
                <input class="form-control input-lg" type="password" id="cpassword" name="cpassword" placeholder="Konfirmasi Kata Sandi *" required>
              </div>
              <div id="passwordError" class="btn btn-flat btn-danger hide-me" >
                    Kata Sandi Tidak Cocok!! 
              </div>
              
              <label style="color: red;">Masukkan CV Anda</label>

              <div class="form-group">
                <label style="color: red;">Dalam Bentuk PDF!</label>
