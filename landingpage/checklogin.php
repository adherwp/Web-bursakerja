...
if(isset($_POST)) {
	...
	$sql = "SELECT users.id_user, users.email, users.active, pencaker.nama FROM users INNER JOIN pencaker ON pencaker.id_user = users.id_user WHERE email='$email' AND password='$password'";
