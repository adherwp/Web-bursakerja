...
if(isset($_POST)) {
	...
	$activationcode=md5($email.time());
		...
		$sql = "INSERT INTO users(email, password, resume, hash, aboutme, active, activation_code) VALUES ('$email', '$password', '$file', '$hash', '$aboutme','2', '$activationcode')";
		...
		if($conn->query($sql)===TRUE) {
			...
			$ms="<html></body><div><div>Hai $email,</div></br></br>";
			$ms.="<div style='padding-top:8px;'>Klik tautan di bawah ini untuk memverifikasi dan mengaktifkan akun kamu</div>
			<div style='padding-top:10px;'><a href='http://localhost:81/PKL/BursaKerja/landingpage/verifikasi-email.php?code=$activationcode'>Click Here</a></div>
			</body></html>";

			// <form action='http://localhost:81/PKL/BursaKerja/landingpage/verifikasi-email.php?code=$activationcode'>
			...
			// $mail->Password = '';
			// $mail->SetFrom('', 'Disnaker Kabupaten Malang');
