...
<div class="wrapper">
  ...
  <?php
    ...
    $sql = "SELECT * FROM buat_artikel WHERE id_berita='$_GET[id]'";
        ...
        <div class="row">          
          <div class="col-md-9 bg-white padding-2">
            ...
            <div class="pull-right">
              <a href="../index.php" class="btn btn-default btn-lg btn-flat margin-top-20"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
            </div>
