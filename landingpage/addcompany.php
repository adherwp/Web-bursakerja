...
if(isset($_POST)) {
	...
	$country = mysqli_real_escape_string($conn, $_POST['kecamatan']);
	$state = mysqli_real_escape_string($conn, $_POST['kelurahan-desa']);
	$kecamatan = mysqli_real_escape_string($conn, $_POST['alamat']);
	...
	if($result->num_rows == 0) {
		...
		$sql = "INSERT INTO company(name, companyname, kecamatan, kelurahan_desa, alamat, contactno, website, email, password, aboutme, logo) VALUES ('$name', '$companyname', '$country', '$state', '$kecamatan', '$contactno', '$website', '$email', '$password', '$aboutme', '$file')";
