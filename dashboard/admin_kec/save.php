...
$nama = "SELECT nama FROM pencaker WHERE id = $id_pencaker";
$hasilNama = $conn->query($nama);
$rowNama = $hasilNama->fetch_assoc();
        ...
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <div class="pull-right">
              <div class="btn btn-default btn-lg btn-flat margin-top-20" id="printDiv"><i class="fa fa-print"></i> Cetak Kartu Kuning</div>
            </div>
            <div class="pull-right">
              ...
              <div class="col-md-12">
                <div class="box-body table-responsive no-padding">
                  <div id="print-this" style="margin-top: 30px;">
                        <!-- <div id="camat" style=" position: absolute; z-index : 99; width: 20%; top: 74%; left: 75%; text-align: center;">
                          <p>Camat <?php echo $row['kecamatan']?></p>
                        </div> -->
                    <!-- <div class="col-md-12"> -->
                      <!-- Div yang mau di print -->
                          ...
                          <table style="width: 100%; padding: 20px;">
                            ...
                            <tr>
                              ...
                              <p>
                                  <?php 
                                  $sqlNo = "SELECT nik FROM pencaker WHERE id = '$id_pencaker'";
                            ...
                            <tr>
                              <td rowspan="1" style="text-align: center;">
                                <img src="../../uploads/foto_pribadi/<?php echo $row['pas_foto']?>" style="width: 177px; height: 236px;"><br>
                              </td>
                            ...
                            <tr>
                              ...
                              <td colspan="2">
                                <table width="90%" style="border-spacing: 0; border: 0.5px solid black;">
                                  ...
                                  <tr>
                                    <td style="border: 0.5px solid black;"><p>&nbsp;Pertama</p></td>
                                    <td style="border: 0.5px solid black;"><p>&nbsp;</p></td>
                                    <td style="border: 0.5px solid black;"><p>&nbsp;</p></td>
                                  </tr>
                                  <tr>
                                    <td style="border: 0.5px solid black;"><p>&nbsp;Kedua</p></td>
                                    <td style="border: 0.5px solid black;"><p>&nbsp;</p></td>
                                    <td style="border: 0.5px solid black;"><p>&nbsp;</p></td>
                                  </tr>
                                  <tr>
                                    <td style="border: 0.5px solid black;"><p>&nbsp;Ketiga</p></td>
                                    <td style="border: 0.5px solid black;"><p>&nbsp;</p></td>
                                    <td style="border: 0.5px solid black;"><p>&nbsp;</p></td>
                                  </tr>
                                </table>
                            ...
                            <tr>
                              <td style="text-align: center;">
                                <p style="margin-top:20px;"><?php echo $row['nama']; ?></p>
                              </td>
                              <td colspan="2">
                                <br>
                                <table width="90%" style="border: 1px solid black;">
                                  <tr >
                                    ...
                                    <td width="70%" style="padding-right: 10px; padding-bottom: 0px; padding-top: 10px;">
                                  ...
                                  <tr >
                                    ...
                                    <td width="75%" style="padding-right: 10px; padding-bottom: 10px; padding-top: 10px;">
                                      <!-- <hr style="border-bottom: dotted 1px;"> -->.........................................................................................................................
                                    </td>
                                  </tr>
                                </table>
                          ...
                          <table>
                            <tr>
                              ...
                              <td> : </td>
                              <td style="width: 64%;">&nbsp; <?php echo $row['nama']?></td>
                                <!-- <table id="kotakan" >
                                  <tr>
                                    <td style="width: 25px; height: 22px; border: 1px solid black;">
                            ...
                            <tr>
                              ...
                              <td>
                                <table>
                                  <tr>
                                    <td>
                                    &nbsp; <?php echo $row['tmpt_lahir'].' / '.$row['tanggal_lahir']; ?>
                                    </td>
                                    <!-- <td style="width: 25px; height: 22px; border: none"></td>
                                    <td style="width: 25px; height: 22px; border: none"></td>
                                    <td style="width: 25px; height: 22px; border: none"></td>
                        ...
                        <tr>
                            ...
                            <tr>
                              <td style="text-decoration:underline"><b>PENDIDIKAN FORMAL/NON FORMAL</b></td>
                              <td >&nbsp;</td>
                              <td >&nbsp;</td>
                            </tr>

                            <?php $sql1 = "SELECT * FROM pendidikan WHERE id_pencaker = $id_pencaker";
                            ...
                            <tr>
                              ...
                              <td>
                                <table width="100%">
                                  <tr>
                                    <?php 
                                    if (empty($row1['tidak_tamat'])) {
                                      echo "<td width=41%>.....................................................</td>";
                                    } else {
                                      echo '<td width=41%>&nbsp;'.$row1['tidak_tamat'].'</td>';
                                    }  
                                    
                                    if (empty($row1['thn_tidak_tamat'])) {
                                      echo "<td width=30%>&ensp;Th&nbsp;..................</td>";
                                    } else {
                                      echo "<td width=30%>&ensp;Th &nbsp;".$row1['thn_tidak_tamat']."</td>";
                                    } 
                                    ?>
                                    <td></td>
                                  </tr>
                                ...
                                <table width="100%">
                                  <tr>
                                    ...
                                    if (empty($row1['sd'])) {
                                      ...
                                      echo '<td width=41%>&nbsp;'.$row1['sd'].'</td>';
                                    }  
                                    
                                    if (empty($row1['thn_sd'])) {
                                      echo "<td width=30%>&ensp;Th&nbsp;..................</td>";
                                    } else {
                                      echo "<td width=30%>&ensp;Th &nbsp;".$row1['thn_sd']."</td>";
                                    } 
                                    ?>
                                    <!-- <td></td> -->
                                    <td style="text-align: center;"><span>Camat 
                                      <?php 
                                ...
                                <table width="100%">
                                  <tr>
                                    ...
                                    if (empty($row1['smp'])) {
                                      ...
                                      echo '<td width=41%>&nbsp;'.$row1['smp'].'</td>';
                                    }  
                                    
                                    if (empty($row1['thn_smp'])) {
                                      echo "<td width=30%>&ensp;Th&nbsp;..................</td>";
                                    } else {
                                      echo "<td width=30%>&ensp;Th &nbsp;".$row1['thn_smp']."</td>";
                                    } 
                                    ?>
                                ...
                                <table width="100%">
                                  <tr>
                                    ...
                                    if (empty($row1['sma'])) {
                                      ...
                                      echo '<td width=41%>&nbsp;'.$row1['sma'].'</td>';
                                    }  
                                    
                                    if (empty($row1['thn_sma'])) {
                                      echo "<td width=30%>&ensp;Th&nbsp;..................</td>";
                                    } else {
                                      echo "<td width=30%>&ensp;Th &nbsp;".$row1['thn_sma']."</td>";
                                    } 
                                    ?>
                                    <!-- <td width=35%>....................................................</td>
                                    <td width=30%>&ensp;Th........................</td> -->
                                    <td></td>
                                ...
                                <table width="100%">
                                  ...
                                  <?php 
                                    if (empty($row1['sm'])) {
                                      ...
                                      echo '<td width=41%>&nbsp;'.$row1['sm'].'</td>';
                                    }  
                                    
                                    if (empty($row1['thn_sm'])) {
                                      echo "<td width=30%>&ensp;Th&nbsp;..................</td>";
                                    } else {
                                      echo "<td width=30%>&ensp;Th &nbsp;".$row1['thn_sm']."</td>";
                                    } 
                                    ?>
                                    <td></td>
                            ...
                            <tr>
                              ...
                              <td>
                                <table width="100%">
                                  <tr>
                                  <?php 
                                    if (empty($row1['akta_dua'])) {
                                      echo "<td width=41%>.....................................................</td>";
                                    } else {
                                      echo '<td width=41%>&nbsp;'.$row1['akta_dua'].'</td>';
                                    }  
                                    
                                    if (empty($row1['thn_akta_dua'])) {
                                      echo "<td width=30%>&ensp;Th&nbsp;..................</td>";
                                    } else {
                                      echo "<td width=30%>&ensp;Th &nbsp;".$row1['thn_akta_dua']."</td>";
                                    } 
                                    ?>
                                    <td></td>
                            ...
                            <tr>
                              ...
                              <td>
                                <table width="100%">
                                  ...
                                  <?php 
                                    if (empty($row1['akta_tiga'])) {
                                      echo "<td width=41%>.....................................................</td>";
                                    } else {
                                      echo '<td width=41%>&nbsp;'.$row1['akta_tiga'].'</td>';
                                    }  
                                    
                                    if (empty($row1['thn_akta_tiga'])) {
                                      echo "<td width=30%>&ensp;Th&nbsp;..................</td>";
                                    } else {
                                      echo "<td width=30%>&ensp;Th &nbsp;".$row1['thn_akta_tiga']."</td>";
                                    } 
                                    ?>
                                    <td></td>
                                  </tr>
                            ...
                            <tr>
                              <td><b>S / PASCA / S.1 / AKTA IV / D.IV</b></td>
                              <td> : </td>
                              <td>
                                <table width="100%">
                                  <tr>
                                    <?php 
                                    if (empty($row1['sarjana'])) {
                                      echo "<td width=41%>.....................................................</td>";
                                    } else {
                                      echo '<td width=41%>&nbsp;'.$row1['sarjana'].'</td>';
                                    }  
                                    
                                    if (empty($row1['thn_sarjana'])) {
                                      echo "<td width=30%>&ensp;Th&nbsp;..................</td>";
                                    } else {
                                      echo "<td width=30%>&ensp;Th &nbsp;".$row1['thn_sarjana']."</td>";
                                    } 
                                    ?>
                                    <td style="text-align: center;">..................................</td>
                                  </tr>
                            ...
                            <tr>
                              <td><b>DOKTOR / S.II / AKTA V</b></td>
                              <td> : </td>
                              <td>
                                <table width="100%">
                                  <tr>
                                  <?php 
                                    if (empty($row1['doktor'])) {
                                      echo "<td width=41%>.....................................................</td>";
                                    } else {
                                      echo '<td width=41%>&nbsp;'.$row1['doktor'].'</td>';
                                    }  
                                    
                                    if (empty($row1['thn_doktor'])) {
                                      echo "<td width=30%>&ensp;Th&nbsp;..................</td>";
                                    } else {
                                      echo "<td width=30%>&ensp;Th &nbsp;".$row1['thn_doktor']."</td>";
                                    } 
                                    ?>
                                    <td></td>
                                  </tr>
                            ...
                            <tr>
                              <td colspan="3">
                                <?php $sqlNonFormal = "SELECT * FROM pendidikan_non_formal WHERE id_pencaker = $id_pencaker";
                                ...
                                <?php
                                  if ($rowNonFormal['penyelenggara'] != 'Tidak Ada') {
                                    echo "<td width='59%'>";
                                    echo $nomor++."&ensp;".$rowNonFormal['penyelenggara'];
                                    echo "</td>";
                                    echo "<td width=44%>Th ".$rowNonFormal['thn_kursus']."</td>";
                                  } else {
                                    echo "<td width='59%'>".$nomor."&ensp;...............................................................................</td>";
                                    echo "<td width=44%>Th ...........................</td>";
                                  }
                                }
                              } 
                                ?>
...
<script>
  $(document).ready(function () {
    ...
    $('#printDiv').click(function() {
      ...
      var b =  document.getElementById('print-this').innerHTML
      console.log(a);

      document.title = "Kartu Kuning - " + "<?php echo $rowNama['nama'];?>";
