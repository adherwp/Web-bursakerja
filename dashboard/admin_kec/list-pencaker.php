        ...
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <div>
              ...
              <form action="list-pencaker.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row margin-top-20">
              <div class="col-md-12">
              <?php if(!empty($idKecamatan)){ ?>
            <label>Hasil dari : <?php echo $idKecamatan ?></label>
              <?php } ?>
                <div class="box-body table-responsive no-padding">
                  <table id="example2" class="table table-hover">
                    <thead>
                      ...
                      <th><div align="center">Cetak </br>Kartu Kuning</div></th>
                    ...
                    <tbody>
                      <?php
                       if(!empty($idKecamatan)){
                        $sql = "SELECT pencaker.id, pencaker.tgl_pendaftaran, pencaker.nama, pencaker.kecamatan, pencaker.desa, users.active, users.id_user FROM users JOIN pencaker ON users.id_user=pencaker.id_user WHERE pencaker.kecamatan='$idKecamatan' AND users.active NOT IN (3)";
                        $result = $conn->query($sql);
                       }else{
                        $sql = "SELECT pencaker.id, pencaker.tgl_pendaftaran, pencaker.nama, pencaker.kecamatan, pencaker.desa, users.active, users.id_user FROM users JOIN pencaker ON users.id_user=pencaker.id_user AND users.active NOT IN (3)";
                        $result = $conn->query($sql);
                       }
                            if($result->num_rows > 0) {
                              ...
                              {
                      ?>
                      <!-- data-href="view-datapencaker.php?id=<?php echo $row['id']; ?>" -->
                      <tr style="cursor: pointer;">
                        ...
                        <td>
                          <div align="center"><?php 
                                $strTgl = strtotime($row['tgl_pendaftaran']);
                        ...
                        <?php
                          if($row['active'] == '1') {
                            ...
                            ?>
                           <a href="approve-user.php?id=<?php echo $row['id_user']; ?>"><span class="label label-primary">VERIFIKASI</span></a>&nbsp<a href="alasan-tolak.php?id=<?php echo $row['id_user']; ?>"><span class="label label-danger">TOLAK</span></a> 
                            <?php
                        ...
                        <td>
                        <div align="center"><a href="save.php?id=<?php echo $row['id']; ?>"><span class="label label-primary">Cetak</span></a> </div></td>
                          <!-- kalo bisa if terverifikasi baru keluar tombol itu -->
                        </td>
                        <td> <div align="center"><a href="delete-user.php?id=<?php echo $row['id']; ?>"><span class="label label-warning">Hapus</span></a></div></td>
                      </tr>
                      <?php
