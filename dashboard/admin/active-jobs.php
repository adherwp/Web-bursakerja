              ...
              <div class="col-md-12">
                <div class="box-body table-responsive no-padding">
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                      <?php
                      $sql = "SELECT buat_lowongan.*, company.companyname FROM buat_lowongan INNER JOIN company ON buat_lowongan.id_company=company.id_company";
                      ...
                      <tr>
                        ...
                        <td><a href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><i class="fa fa-address-card-o">&nbsp&nbsp<span class="label label-info">Tampilkan Lowongan</span></i></a></td>
                        <td><a href="delete-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><i class="fa fa-trash">&nbsp&nbsp<span class="label label-success">Hapus Lowongan</span></i></a></td>
                      </tr>  
                            <?php
                        }
                      }
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
              <h3><b>Dibuat Pada</b></h3>
              <p>22/06/2019</p>
              <br>              
              <h3><b>Nama UMKM</b></h3>
              <p>Haidar Majujaya</p>
              <br>
              <h3><b>Email UMKM</b></h3>
              <p>test@test.com</p>
              <br>
              <h3><b>Lokasi</b></h3>
              <p>Malang</p>
