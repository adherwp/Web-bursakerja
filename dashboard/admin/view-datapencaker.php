      ...
      ?>
        ...
        <div class="col-md-12 bg-white padding-2 d-flex justify-content-between">
              <div class="row">
                ...
                <a href="applications.php" class="btn btn-default btn-lg btn-flat margin-top-20"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                </div>
              </div>
            <div>
              ...
              // echo "</div>";
                ...
                foreach ($images as $i => $image) {
                  ...
                  echo '<div class="row" style="margin-top: 10px;">';
                    if($i === 0)
                      echo '<div class="btn btn-primary btn-block" > <a href="download_file.php?file='. urlencode($image) .'" style="color: #ffffff">Download Foto Pribadi </a> </div>';
                      // echo  '<p><a href="download_file.php?file=' . urlencode($image) . '">Download Foto Pribadi</a></p>';
                    elseif($i === 1)
                      echo '<div class="btn btn-primary btn-block" > <a href="download_file.php?file='. urlencode($image) .'" style="color: #ffffff">Download Ijazah </a> </div>';
                    elseif($i === 2)
                      echo '<div class="btn btn-primary btn-block" > <a href="download_file.php?file='. urlencode($image) .'" style="color: #ffffff">Download KTP </a> </div>';
                    elseif($i === 3)
                      echo '<div class="btn btn-primary btn-block" > <a href="download_file.php?file='. urlencode($image) .'" style="color: #ffffff">Download Akte </a> </div>';
                    elseif($i === 4)
                      echo '<div class="btn btn-primary btn-block" > <a href="download_file.php?file='. urlencode($image) .'" style="color: #ffffff">Download Sertifikat </a> </div>';
                  echo  '</div>';
                }
                echo  '</div>';
                ?>
