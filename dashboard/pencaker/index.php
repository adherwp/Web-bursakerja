      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
               <ul class="nav nav-pills nav-stacked">
                  <li><a href="daftar-pengajuan.php"><i class="fa fa-user"></i> Daftar Pengajuan</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>Lamaran Terbaru</i></h2>
            <p>Disini anda bisa mengecek aktivitas anda saat mencari pekerjaan</p>

            <?php
             $sql = "SELECT * FROM buat_lowongan INNER JOIN lowongan ON buat_lowongan.id_jobpost=lowongan.id_jobpost WHERE lowongan.id_user='$_SESSION[id_user]'";
