        ...
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <div class="alert alert-info alert-dismissible">
                ...
                <i class="icon fa fa-info"></i> Di dashboard ini anda bisa mengatur data UMKM Anda, Membuat Lowongan, dan Memantau para pencaker yang melamar.
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Lowongan yang Dibuat</span>
                    <?php
                    $sql = "SELECT * FROM buat_lowongan WHERE id_company IN (SELECT id_company from company WHERE id_pengusaha = '$_SESSION[id_pengusaha]')";
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Pelamar di UMKM Saya</span>
                    <?php
                    $sql = "SELECT * FROM lowongan WHERE id_company IN (SELECT id_company from company WHERE id_pengusaha = '$_SESSION[id_pengusaha]')";
                    $result = $conn->query($sql);
