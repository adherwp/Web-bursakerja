...
if(isset($_POST)) {
	...
	$city = mysqli_real_escape_string($conn, $_POST['kecamatan']);
	$state = mysqli_real_escape_string($conn, $_POST['kelurahan_desa']);
	...
	$sql = "UPDATE company SET companyname='$companyname', website='$website', kecamatan='$city', kelurahan_desa='$state', contactno='$contactno', aboutme='$aboutme'";
