      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <p>Disini anda bisa mengatur akun anda atau me-non aktifkan akun anda</p>
            <div class="row">
              <div class="col-md-6">
                <form id="changePassword" action="change-password.php" method="post">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-flat btn-success btn-lg">Perbarui Kata Sandi</button>
                  </div>
              ...
              <div class="col-md-6">
                <form action="update-name.php" method="post">
                  <div class="form-group">
                    <label>Perbarui Nama Lengkap Anda</label>
                    <input class="form-control input-lg" name="name" type="text">
                  </div>
                  <div class="form-group">
                    <button type="submit" class="btn btn-flat btn-primary btn-lg">Perbarui</button>
                  </div>
                </form>
              </div>              
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <form action="deactivate-account.php" method="post">
                  <label><input type="checkbox" required> Saya Ingin Non-Aktifkan Akun Saya</label>
                  <button class="btn btn-danger btn-danger btn-lg">Non-Aktifkan Akun Saya</button>
                </form>
              </div>
            </div>
