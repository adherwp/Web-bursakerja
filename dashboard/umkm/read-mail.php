...
$sql = "SELECT * FROM mailbox WHERE id_mailbox='$_GET[id_mail]' AND (id_fromuser IN (SELECT id_company from company WHERE id_pengusaha = '$_SESSION[id_pengusaha]') OR id_touser IN (SELECT id_company from company WHERE id_pengusaha = '$_SESSION[id_pengusaha]'))";
                ...
                if($resultReply->num_rows > 0) {
                  ...
                  <div class="box box-primary">
                    <div class="box-body no-padding">
                      <div class="mailbox-read-info">
                        <h3>Balas Pesan</h3>
                        <h5>Dari: <?php if($rowReply['usertype'] == "company") { echo $rowCompany['companyname']; } else { echo $rowUser['nama']; } ?>
