        ...
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            <div class="row margin-top-20">
              <div class="col-md-12">
              <?php
               $sql = "SELECT * FROM buat_artikel WHERE id_company='$_SESSION[id_pengusaha]' AND id_berita='$_GET[id]'";
                ...
                ?>
                <div class="pull-left">
                  <h2><b><i><?php echo $row['judul_berita']; ?></i></b></h2>
                </div>
                ...
                <div>
                  <?php echo stripcslashes($row['deskripsi']); ?>
                </div>
                <div>
                </div>
                <?php
