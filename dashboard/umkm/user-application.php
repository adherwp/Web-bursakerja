...
$sql = "SELECT * FROM lowongan WHERE id_company IN (SELECT id_company from company WHERE id_pengusaha = '$_SESSION[id_pengusaha]') AND id_user='$_GET[id]'";
        ...
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                ...
                <li><a href="index.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                  ...
                  <li class="active"><a href="job-applications.php"><i class="fa fa-users"></i> Pelamar di UMKM Saya</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <div class="row margin-top-20">
              <div class="col-md-12">
              <?php
               $sql = "SELECT users.*, pencaker.nama, pencaker.kecamatan FROM users INNER JOIN pencaker ON pencaker.id_user = users.id_user WHERE users.id_user='$_GET[id]'";
                $result = $conn->query($sql);
                ...
                <div>
                  <?php
                    ...
                    echo '<br>';
                    echo 'Kecamatan: '.$row['kecamatan'];
                    echo '<br>';
                    
                      echo '<a href="../../uploads/cv/'.$row['resume'].'" class="btn btn-info" download="Resume">Download CV/Resume</a>';
                  ...
                  <div class="row">
                    <div class="col-md-3 pull-left">
                      <a href="under-review.php?id=<?php echo $row['id_user']; ?>&id_jobpost=<?php echo $_GET['id_jobpost']; ?>&id_company=<?php echo $_GET['id_company']; ?>" class="btn btn-success">Tandai Sedang Diseleksi</a>
                    </div>
                    <div class="col-md-3 pull-right">
                      <a href="reject.php?id=<?php echo $row['id_user']; ?>&id_jobpost=<?php echo $_GET['id_jobpost']; ?>&id_company=<?php echo $_GET['id_company']; ?>" class="btn btn-danger">Tolak Berkas Pelamar</a>
                    </div>
                  </div>
                </div>
