...
if(isset($_POST)) {
	...
	if($result->num_rows == 0 ) {
		...
		// if($uploadOk == false) {
		// 	header("Location: register-umkm.php");
		// 	exit();
		// }

		//sql new registration insert query
		$sql = "INSERT INTO company(companyname, aboutme, kecamatan, kelurahan_desa, alamat, contactno, website, email, logo, id_pengusaha) VALUES ('$companyname', '$aboutme', '$kecamatan', '$kelurahan_desa', '$alamat', '$contactno', '$website', '$email', '$file', '$_SESSION[id_pengusaha]')";
