...
if(isset($_POST)) {
	...
	$stmt = $conn->prepare("INSERT INTO buat_lowongan(id_company, jobtitle, description, minimumsalary, maximumsalary, experience, qualification) VALUES (?,?, ?, ?, ?, ?, ?)");

	$stmt->bind_param("sssssss", $idcompany, $jobtitle, $description, $minimumsalary, $maximumsalary, $experience, $qualification);

	$idcompany = mysqli_real_escape_string($conn, $_POST['company']);
	...
	// $sql = "INSERT INTO buat_lowongan(id_company, jobtitle, description, minimumsalary, maximumsalary, experience, qualification) VALUES ('$_SESSION[id_company]','$jobtitle', '$description', '$minimumsalary', '$maximumsalary', '$experience', '$qualification')";
