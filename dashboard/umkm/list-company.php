              ...
              <div class="col-md-12">
                <div class="box-body table-responsive no-padding">
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                      <?php
                      $sql = "SELECT * FROM company WHERE id_pengusaha ='$_SESSION[id_pengusaha]'";
                      ...
                      <tr>
                        ...
                        <td><a href="delete-company.php?id=<?php echo $row['id_company']; ?>">Hapus</a></td>
                        <td><a href="edit-company.php?id=<?php echo $row['id_company'];?>">Ubah</a></td>
                      </tr>  
                     <?php
                        }
                      } else {
                        ?>
                        <tr>
                        <td>Belum ada tempat usaha yang terdaftar.</td>
                        </tr>
                        <?php
                      }
                    ?>
                ...
                <div class="form-group" style="margin-top : 25px">
                  <a href="register-umkm.php"><button class="btn btn-flat btn-success" href=""> + Tambah Tempat Usaha</button></a>
                </div>
              </div>
            </div>
