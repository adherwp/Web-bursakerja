      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>UMKM Saya</i></h2>
            <p>Disini Anda Bisa Memperbarui Data UMKM Anda</p>
            <div class="row">
              <form action="update-company.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    <label>Tantang Kami</label>
                    <textarea class="form-control input-lg" rows="4" name="aboutme"><?php echo $row['aboutme']; ?></textarea>
                  </div>
                  <div class="form-group">
                    <button type="submit" class="btn btn-flat btn-success">Perbarui Data UMKM</button>
                  </div>
                </div>
                <div class="col-md-6 latest-job ">
                  <div class="form-group">
                    <label for="contactno">Nomor Telpon</label>
                    <input type="text" class="form-control input-lg" id="contactno" name="contactno" placeholder="Nomor Telpon" value="<?php echo $row['contactno']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="kecamatan">Kecamatan</label>
                    <input type="text" class="form-control input-lg" id="kecamatan" name="kecamatan" value="<?php echo $row['kecamatan']; ?>" placeholder="kecamatan">
                  </div>
                  <div class="form-group">
                    <label for="kelurahan_desa">Desa</label>
                    <input type="text" class="form-control input-lg" id="kelurahan_desa" name="kelurahan_desa" placeholder="Desa" value="<?php echo $row['kelurahan_desa']; ?>">
                  </div>
                  <div class="form-group">
                    <label>Ubah Logo UMKM</label>
