            ...
            <div class="row margin-top-20">
              ...
              <?php
               $sql = "SELECT * FROM buat_lowongan WHERE id_company='$_GET[id_company]' AND id_jobpost='$_GET[id]'";
                ...
                <hr>
                <div>
                  <p><span class="margin-right-10"><i class="fa fa-location-arrow text-green"></i> <?php echo $row['experience']; ?> Tahun Pengalaman Kerja</span> <i class="fa fa-calendar text-green"></i> <?php echo date("d-M-Y", strtotime($row['createdat'])); ?> 
