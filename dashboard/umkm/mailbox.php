      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title" style="margin-bottom: 20px;">Kotak Pesan</h3>
              <div class="pull-right">
                <a href="create-mail.php" class="btn btn-warning btn-flat"><i class="fa fa-envelope"></i> Tulis Email</a>
              </div>
              <!-- /.box-tools -->
            </div>
            <!-- /.box-header -->
                ...
                <table id="example1" class="table table-hover table-striped">
                  <thead>
                    <tr>
                      <th>Subjek</th>
                      <th>Tanggal</th>
                      <th>Dikirim untuk Perusahaan</th>
                    </tr>
                  </thead>
                  <tbody>
                  <?php
                    $sql = "SELECT a.*,b.companyname FROM mailbox as a INNER JOIN company as b ON a.id_touser = b.id_company  WHERE id_fromuser IN (SELECT id_company from company WHERE id_pengusaha = '$_SESSION[id_pengusaha]') OR id_touser IN (SELECT id_company from company WHERE id_pengusaha = '$_SESSION[id_pengusaha]')";
