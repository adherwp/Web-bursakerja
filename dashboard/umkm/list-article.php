      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                ...
                <li><a href="index.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                  ...
                  <li class="active"><a href="list-article.php"><i class="fa fa-newspaper-o"></i> Daftar Artikel</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>Daftar Artikel Saya</i></h2>
            <p>Disini Anda Bisa Melihat Daftar Artikel Yang Sudah Anda Buat.</p>
              ...
              <div class="col-md-12">
                <div class="box-body table-responsive no-padding">
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                    <?php
                     $sql = "SELECT * FROM buat_artikel WHERE id_company='$_SESSION[id_pengusaha]'";
                      ...
                      <tr>
                        ...
                        <td><a href="view-article.php?id=<?php echo $row['id_berita']; ?>"><i class="fa fa-address-card">&nbsp&nbsp<span class="label label-primary">Tampilkan</span></i></a></td>
                        <td><a href="delete-article.php?id=<?php echo $row['id_berita']; ?>"><span class="label label-danger">Hapus</span></i></a></td>
                      </tr>
                      <?php
                       }
                     }
