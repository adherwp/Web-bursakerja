      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                ...
                <li><a href="index.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                  ...
                  <li class="active"><a href="resume-database.php"><i class="fa fa-user"></i> Data Pelamar</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>Data Pelamar </i></h2>
            <p>Disini anda bisa melakukan review terhadap pelamar di UMKM anda, diini CV/Resume Pelamar bisa di unduh</p>
              ...
              <div class="col-md-12">
                <div class="box-body table-responsive no-padding">
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                    <?php
                       $sql = "SELECT users.*, pencaker.nama, pencaker.kecamatan, pencaker.desa FROM buat_lowongan INNER JOIN lowongan ON buat_lowongan.id_jobpost=lowongan.id_jobpost INNER JOIN users ON users.id_user=lowongan.id_user INNER JOIN pencaker ON pencaker.id_user=users.id_user WHERE lowongan.id_company IN (SELECT id_company from company WHERE id_pengusaha = '$_SESSION[id_pengusaha]') GROUP BY users.id_user";
                      ...
                      <tr>
                        ...
                        <?php if($row['resume'] != '') { ?>
                        <td><a href="../../uploads/cv/<?php echo $row['resume']; ?>" download="<?php echo $row['nama'].' Resume'; ?>"><i class="fa fa-file-pdf-o">&nbsp&nbsp<span class="label label-success">Unduh</span> </i></a></td>
                        <?php } else { ?>
