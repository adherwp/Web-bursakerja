      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>Daftar Lowongan Saya</i></h2>
            <p>Disini Anda Bisa Melihat Daftar Lowongan Yang Sudah Anda Buat.</p>
              ...
              <div class="col-md-12">
                <div class="box-body table-responsive no-padding">
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                    <?php
                     $sql = "SELECT a.*,b.companyname FROM buat_lowongan as a INNER JOIN company as b ON a.id_company = b.id_company WHERE b.id_pengusaha = '$_SESSION[id_pengusaha]'";
