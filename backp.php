      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <h1 class="text-center margin-bottom-20">Tambah Berita</h1>
            <br>
            <div class="row">
              <div class="">
                <form method="post" id="tambahBerita" action="news-save.php" enctype="multipart/form-data">
                  <div class="col-md-6 latest-job ">

                    <div class="form-group" style="width: 100%">
                      <input class="form-control input-lg" type="text" id="judul" name="judul" placeholder="Judul Berita" required>
                    </div>

                    <div id="isiBerita" class="form-group">
                      <textarea class="form-control input-lg" name="isi" placeholder="Isi Berita di sini" style="height: 250px; width: 700px;">
                        
                      </textarea>
                    </div>

                    <div class="form-group">
                      <input type="file" name="gambar" class="form-control input-lg" required>
                    </div>

                    <div class="form-group">
                      <button type="submit" class="btn btn-flat btn-success">Tambah Berita</button>
                    </div>
